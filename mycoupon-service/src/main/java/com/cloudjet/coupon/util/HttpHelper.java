...
//	        httpPost.setHeader("User-Agent", "Mozilla/4.0 (compatible; MSIE 5.0; Windows NT; DigExt)");
	...
	public static void main(String[] args){
		...
		params.put("text", "8天在线-春节档「乘风破浪」送票活动,券已经到账，券码：TZ5MQKEMQZDE。1月28号在格瓦拉开始兑换，请于2017年02月22日前使用。本短信转发无效。");
		params.put("mobile", "15538204515");
		String resStr = HttpHelper.httpPostParam("http://promotion.izhuan100.com/wechat/sms/send.do",
				params, "UTF-8");
		...
		System.out.println(msgRes.getResultCode());
	}
